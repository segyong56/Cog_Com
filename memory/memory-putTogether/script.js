...
function showQestion() {
  ...
  for (let i = 0; i < 4; i++) {
    ...
    name_img.src = `./image/${currentCard.q[i]}`;
...
function showName() {
  dragArea.innerHTML =
    '<div class="drag" id="drop0">' +
    currentCard.nameTag[0] +
    "</div>" +
    '<div class="drag" id="drop1">' +
    currentCard.nameTag[1] +
    "</div>" +
    '<div class="drag" id="drop2">' +
    currentCard.nameTag[2] +
    "</div>" +
    '<div class="drag" id="drop3">' +
    currentCard.nameTag[3] +
    "</div>";
  ...
  nameBox.innerHTML =
    '<div class="name ' +
    currentCard.correct[0] +
    '" id="div0"></div>' +
    '<div class="name ' +
    currentCard.correct[1] +
    '" id="div1"></div>' +
    '<div class="name ' +
    currentCard.correct[2] +
    '" id="div2"></div>' +
    '<div class="name ' +
    currentCard.correct[3] +
    '" id="div3"></div>';
